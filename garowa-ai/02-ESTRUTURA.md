...
| Jurídico: contrato com mandato, LGPD, cláusula de território | R$ 5–10 mil |
...
|---|---|---|---|---|
| Mês 1–2 (montagem) | 3 | R$ 30–35 mil | zero | −R$ 65–90 mil |
| Mês 3 (piloto, 3 clientes) | 3 | R$ 30–35 mil | ~R$ 1,5 mil | −R$ 100–125 mil |
| Mês 4–6 (venda inicial) | 3 + SDR | R$ 36–41 mil | R$ 5–10 mil/mês | −R$ 180–250 mil |
...
- **06 · Observabilidade e custo** — Quanto cada cliente custou hoje, em qual chamada, com alerta.
  - Já existe no Radar: sim; alerta em R$ 25 por cliente por mês
- **07 · Renderização e entrega** — Cartões, mapas, PDFs de uma página, envio e reenvio.
...
- Mudança irreversível ou sensível na conta do cliente: dois olhos humanos, sempre
- Primeira publicação em nome de um cliente novo: aprovação antes
- Resposta a reclamação pública: humano escreve, agente ajuda
- Qualquer coisa que a casa não consiga registrar com prova
...
## A MENOR VERSÃO QUE FUNCIONA {.fecho}
